...
// Validate checks the field values on SyncStats with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on SyncStats with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SyncStatsMultiError, or nil
// if none found.
func (m *SyncStats) ValidateAll() error {
	return m.validate(true)
}

func (m *SyncStats) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for GrantsByResourceType
...
// SyncStatsMultiError is an error wrapping multiple validation errors returned
// by SyncStats.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m SyncStatsMultiError) AllErrors() []error { return m }

// SyncStatsValidationError is the validation error returned by
// SyncStats.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e SyncStatsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SyncStatsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SyncStatsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SyncStatsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SyncStatsValidationError) ErrorName() string { return "SyncStatsValidationError" }
...
var _ error = SyncStatsValidationError{}
