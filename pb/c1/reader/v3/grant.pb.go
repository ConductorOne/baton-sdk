...
type GrantsReaderServiceGetGrantResponse struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Grant         *v3.GrantRecord        `protobuf:"bytes,1,opt,name=grant,proto3" json:"grant,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GrantsReaderServiceListGrantsForEntitlementResponse struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	List          []*v3.GrantRecord      `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
