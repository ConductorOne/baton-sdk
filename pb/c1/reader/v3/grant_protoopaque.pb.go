...
// 	protoc        (unknown)
// source: c1/reader/v3/grant.proto
...
func (x *GrantsReaderServiceGetGrantRequest) Reset() {
	*x = GrantsReaderServiceGetGrantRequest{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[0]
...
type GrantsReaderServiceGetGrantResponse struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Grant *v3.GrantRecord        `protobuf:"bytes,1,opt,name=grant,proto3"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GrantsReaderServiceGetGrantResponse) Reset() {
	*x = GrantsReaderServiceGetGrantResponse{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceGetGrantResponse) GetGrant() *v3.GrantRecord {
	if x != nil {
...
func (x *GrantsReaderServiceGetGrantResponse) SetGrant(v *v3.GrantRecord) {
...
func (x *GrantsReaderServiceListGrantsForEntitlementRequest) Reset() {
	*x = GrantsReaderServiceListGrantsForEntitlementRequest{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
// Deprecated: Marked as deprecated in c1/reader/v3/grant.proto.
...
type GrantsReaderServiceListGrantsForEntitlementResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_List          *[]*v3.GrantRecord     `protobuf:"bytes,1,rep,name=list,proto3"`
...
func (x *GrantsReaderServiceListGrantsForEntitlementResponse) Reset() {
	*x = GrantsReaderServiceListGrantsForEntitlementResponse{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceListGrantsForEntitlementResponse) GetList() []*v3.GrantRecord {
	if x != nil {
...
func (x *GrantsReaderServiceListGrantsForEntitlementResponse) SetList(v []*v3.GrantRecord) {
	x.xxx_hidden_List = &v
}
...
func (x *GrantsReaderServiceListGrantsForResourceTypeRequest) Reset() {
	*x = GrantsReaderServiceListGrantsForResourceTypeRequest{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceListGrantsForResourceTypeResponse) Reset() {
	*x = GrantsReaderServiceListGrantsForResourceTypeResponse{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceListGrantsForResourceTypeResponse) GetList() []*v3.GrantRecord {
	if x != nil {
		if x.xxx_hidden_List != nil {
			return *x.xxx_hidden_List
		}
...
func (x *GrantsReaderServiceListGrantsForResourceTypeResponse) SetList(v []*v3.GrantRecord) {
	x.xxx_hidden_List = &v
}
...
func (x *GrantsReaderServiceListGrantsForEntitlementsRequest) Reset() {
	*x = GrantsReaderServiceListGrantsForEntitlementsRequest{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceListGrantsForEntitlementsResponse) Reset() {
	*x = GrantsReaderServiceListGrantsForEntitlementsResponse{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceListGrantsForEntitlementsResponse) GetList() []*v3.GrantRecord {
	if x != nil {
		if x.xxx_hidden_List != nil {
			return *x.xxx_hidden_List
		}
...
func (x *GrantsReaderServiceListGrantsForEntitlementsResponse) SetList(v []*v3.GrantRecord) {
	x.xxx_hidden_List = &v
}
...
type GrantsReaderServiceListGrantsForEntitlementsResponse_builder struct {
	...
	// visited them. Caller groups by GrantRecord.Entitlement.EntitlementId.
	List          []*v3.GrantRecord
	NextPageToken string
}
...
type GrantsReaderServiceListGrantsForPrincipalRequest struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PrincipalId *v2.ResourceId         `protobuf:"bytes,1,opt,name=principal_id,json=principalId,proto3"`
...
func (x *GrantsReaderServiceListGrantsForPrincipalRequest) Reset() {
	*x = GrantsReaderServiceListGrantsForPrincipalRequest{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (b0 GrantsReaderServiceListGrantsForPrincipalRequest_builder) Build() *GrantsReaderServiceListGrantsForPrincipalRequest {
	m0 := &GrantsReaderServiceListGrantsForPrincipalRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PrincipalId = b.PrincipalId
	x.xxx_hidden_Entitlement = b.Entitlement
...
func (x *GrantsReaderServiceListGrantsForPrincipalResponse) Reset() {
	*x = GrantsReaderServiceListGrantsForPrincipalResponse{}
	mi := &file_c1_reader_v3_grant_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GrantsReaderServiceListGrantsForPrincipalResponse) GetList() []*v3.GrantRecord {
	if x != nil {
		if x.xxx_hidden_List != nil {
			return *x.xxx_hidden_List
		}
...
func (x *GrantsReaderServiceListGrantsForPrincipalResponse) SetList(v []*v3.GrantRecord) {
	x.xxx_hidden_List = &v
}
...
func (b0 GrantsReaderServiceListGrantsForPrincipalResponse_builder) Build() *GrantsReaderServiceListGrantsForPrincipalResponse {
	m0 := &GrantsReaderServiceListGrantsForPrincipalResponse{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_List = &b.List
	x.xxx_hidden_NextPageToken = b.NextPageToken
...
var File_c1_reader_v3_grant_proto protoreflect.FileDescriptor

const file_c1_reader_v3_grant_proto_rawDesc = "" +
	"\n" +
	"\x18c1/reader/v3/grant.proto\x12\fc1.reader.v3\x1a!c1/connector/v2/entitlement.proto\x1a\x1ec1/connector/v2/resource.proto\x1a\x1bc1/storage/v3/records.proto\x1a\x19google/protobuf/any.proto\x1a\x17validate/validate.proto\"\x83\x01\n" +
	...
	"#GrantsReaderServiceGetGrantResponse\x120\n" +
	"\x05grant\x18\x01 \x01(\v2\x1a.c1.storage.v3.GrantRecordR\x05grant\"\x9c\x03\n" +
	...
	"\vannotations\x18\x04 \x03(\v2\x14.google.protobuf.AnyR\vannotations\"\x9c\x01\n" +
	"3GrantsReaderServiceListGrantsForEntitlementResponse\x12.\n" +
	"\x04list\x18\x01 \x03(\v2\x1a.c1.storage.v3.GrantRecordR\x04list\x125\n" +
	...
	"page_token\x18\x03 \x01(\tB\r\xfaB\n" +
	"r\b \x01(\x80\x10\xd0\x01\x01R\tpageToken\x126\n" +
	"\vannotations\x18\x04 \x03(\v2\x14.google.protobuf.AnyR\vannotations\"\x9d\x01\n" +
	...
	"\vannotations\x18d \x03(\v2\x14.google.protobuf.AnyR\vannotations\"\x9d\x01\n" +
	"4GrantsReaderServiceListGrantsForEntitlementsResponse\x12.\n" +
	"\x04list\x18\x01 \x03(\v2\x1a.c1.storage.v3.GrantRecordR\x04list\x125\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\r\xfaB\n" +
	"r\b \x01(\x80 \xd0\x01\x01R\rnextPageToken\"\xcb\x02\n" +
	"0GrantsReaderServiceListGrantsForPrincipalRequest\x12H\n" +
	"\fprincipal_id\x18\x01 \x01(\v2\x1b.c1.connector.v2.ResourceIdB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vprincipalId\x12>\n" +
	"\ventitlement\x18\x02 \x01(\v2\x1c.c1.connector.v2.EntitlementR\ventitlement\x12'\n" +
	"\tpage_size\x18\x03 \x01(\rB\n" +
	"\xfaB\a*\x05\x18\xfa\x01@\x01R\bpageSize\x12,\n" +
	"\n" +
	"page_token\x18\x04 \x01(\tB\r\xfaB\n" +
	"r\b \x01(\x80\x10\xd0\x01\x01R\tpageToken\x126\n" +
	"\vannotations\x18\x05 \x03(\v2\x14.google.protobuf.AnyR\vannotations\"\x9a\x01\n" +
	"1GrantsReaderServiceListGrantsForPrincipalResponse\x12.\n" +
	"\x04list\x18\x01 \x03(\v2\x1a.c1.storage.v3.GrantRecordR\x04list\x125\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\r\xfaB\n" +
	"r\b \x01(\x80\x10\xd0\x01\x01R\rnextPageToken2\x8e\x06\n" +
	"\x13GrantsReaderService\x12o\n" +
	"\bGetGrant\x120.c1.reader.v3.GrantsReaderServiceGetGrantRequest\x1a1.c1.reader.v3.GrantsReaderServiceGetGrantResponse\x12\x9f\x01\n" +
	"\x18ListGrantsForEntitlement\x12@.c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementRequest\x1aA.c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementResponse\x12\xa2\x01\n" +
	"\x19ListGrantsForResourceType\x12A.c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeRequest\x1aB.c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeResponse\x12\xa2\x01\n" +
	"\x19ListGrantsForEntitlements\x12A.c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsRequest\x1aB.c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsResponse\x12\x99\x01\n" +
	"\x16ListGrantsForPrincipal\x12>.c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalRequest\x1a?.c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalResponseB3Z1github.com/conductorone/baton-sdk/pb/c1/reader/v3b\x06proto3"

var file_c1_reader_v3_grant_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_c1_reader_v3_grant_proto_goTypes = []any{
	(*GrantsReaderServiceGetGrantRequest)(nil),                   // 0: c1.reader.v3.GrantsReaderServiceGetGrantRequest
	(*GrantsReaderServiceGetGrantResponse)(nil),                  // 1: c1.reader.v3.GrantsReaderServiceGetGrantResponse
	(*GrantsReaderServiceListGrantsForEntitlementRequest)(nil),   // 2: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementRequest
	(*GrantsReaderServiceListGrantsForEntitlementResponse)(nil),  // 3: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementResponse
	(*GrantsReaderServiceListGrantsForResourceTypeRequest)(nil),  // 4: c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeRequest
	(*GrantsReaderServiceListGrantsForResourceTypeResponse)(nil), // 5: c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeResponse
	(*GrantsReaderServiceListGrantsForEntitlementsRequest)(nil),  // 6: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsRequest
	(*GrantsReaderServiceListGrantsForEntitlementsResponse)(nil), // 7: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsResponse
	(*GrantsReaderServiceListGrantsForPrincipalRequest)(nil),     // 8: c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalRequest
	(*GrantsReaderServiceListGrantsForPrincipalResponse)(nil),    // 9: c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalResponse
	(*anypb.Any)(nil),      // 10: google.protobuf.Any
	(*v3.GrantRecord)(nil), // 11: c1.storage.v3.GrantRecord
	(*v2.Entitlement)(nil), // 12: c1.connector.v2.Entitlement
	(*v2.ResourceId)(nil),  // 13: c1.connector.v2.ResourceId
}
var file_c1_reader_v3_grant_proto_depIdxs = []int32{
	10, // 0: c1.reader.v3.GrantsReaderServiceGetGrantRequest.annotations:type_name -> google.protobuf.Any
	11, // 1: c1.reader.v3.GrantsReaderServiceGetGrantResponse.grant:type_name -> c1.storage.v3.GrantRecord
	12, // 2: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementRequest.entitlement:type_name -> c1.connector.v2.Entitlement
	13, // 3: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementRequest.principal_id:type_name -> c1.connector.v2.ResourceId
	10, // 4: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementRequest.annotations:type_name -> google.protobuf.Any
	11, // 5: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementResponse.list:type_name -> c1.storage.v3.GrantRecord
	10, // 6: c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeRequest.annotations:type_name -> google.protobuf.Any
	11, // 7: c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeResponse.list:type_name -> c1.storage.v3.GrantRecord
	12, // 8: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsRequest.entitlements:type_name -> c1.connector.v2.Entitlement
	10, // 9: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsRequest.annotations:type_name -> google.protobuf.Any
	11, // 10: c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsResponse.list:type_name -> c1.storage.v3.GrantRecord
	13, // 11: c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalRequest.principal_id:type_name -> c1.connector.v2.ResourceId
	12, // 12: c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalRequest.entitlement:type_name -> c1.connector.v2.Entitlement
	10, // 13: c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalRequest.annotations:type_name -> google.protobuf.Any
	11, // 14: c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalResponse.list:type_name -> c1.storage.v3.GrantRecord
	0,  // 15: c1.reader.v3.GrantsReaderService.GetGrant:input_type -> c1.reader.v3.GrantsReaderServiceGetGrantRequest
	2,  // 16: c1.reader.v3.GrantsReaderService.ListGrantsForEntitlement:input_type -> c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementRequest
	4,  // 17: c1.reader.v3.GrantsReaderService.ListGrantsForResourceType:input_type -> c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeRequest
	6,  // 18: c1.reader.v3.GrantsReaderService.ListGrantsForEntitlements:input_type -> c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsRequest
	8,  // 19: c1.reader.v3.GrantsReaderService.ListGrantsForPrincipal:input_type -> c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalRequest
	1,  // 20: c1.reader.v3.GrantsReaderService.GetGrant:output_type -> c1.reader.v3.GrantsReaderServiceGetGrantResponse
	3,  // 21: c1.reader.v3.GrantsReaderService.ListGrantsForEntitlement:output_type -> c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementResponse
	5,  // 22: c1.reader.v3.GrantsReaderService.ListGrantsForResourceType:output_type -> c1.reader.v3.GrantsReaderServiceListGrantsForResourceTypeResponse
	7,  // 23: c1.reader.v3.GrantsReaderService.ListGrantsForEntitlements:output_type -> c1.reader.v3.GrantsReaderServiceListGrantsForEntitlementsResponse
	9,  // 24: c1.reader.v3.GrantsReaderService.ListGrantsForPrincipal:output_type -> c1.reader.v3.GrantsReaderServiceListGrantsForPrincipalResponse
...
func init() { file_c1_reader_v3_grant_proto_init() }
func file_c1_reader_v3_grant_proto_init() {
	if File_c1_reader_v3_grant_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_c1_reader_v3_grant_proto_rawDesc), len(file_c1_reader_v3_grant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_c1_reader_v3_grant_proto_goTypes,
		DependencyIndexes: file_c1_reader_v3_grant_proto_depIdxs,
		MessageInfos:      file_c1_reader_v3_grant_proto_msgTypes,
	}.Build()
	File_c1_reader_v3_grant_proto = out.File
	file_c1_reader_v3_grant_proto_goTypes = nil
	file_c1_reader_v3_grant_proto_depIdxs = nil
}
