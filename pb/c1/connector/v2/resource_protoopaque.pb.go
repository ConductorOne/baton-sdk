...
type ResourceType struct {
	...
	xxx_hidden_SyncBucket        string                 `protobuf:"bytes,7,opt,name=sync_bucket,json=syncBucket,proto3"`
...
func (x *ResourceType) GetSyncBucket() string {
	if x != nil {
		return x.xxx_hidden_SyncBucket
	}
	return ""
}
...
func (b0 ResourceType_builder) Build() *ResourceType {
	...
	x.xxx_hidden_SyncBucket = b.SyncBucket
	return m0
}
...
const file_c1_connector_v2_resource_proto_rawDesc = "" +
	"\n" +
	"\x1ec1/connector/v2/resource.proto\x12\x0fc1.connector.v2\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\"\xf2\x03\n" +
