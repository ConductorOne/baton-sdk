...
const (
	Status_RESOURCE_STATUS_STATUS_UNSPECIFIED Status_ResourceStatus = 0
...
var (
	Status_ResourceStatus_name = map[int32]string{
		0: "RESOURCE_STATUS_STATUS_UNSPECIFIED",
...
func (x *Status) GetStatus() Status_ResourceStatus {
	...
	return Status_RESOURCE_STATUS_STATUS_UNSPECIFIED
}
...
const file_c1_connector_v2_resource_proto_rawDesc = "" +
	"\n" +
	"\x1ec1/connector/v2/resource.proto\x12\x0fc1.connector.v2\x1a\x1bc1/connector/v2/asset.proto\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"\xc4\x04\n" +
	...
	"3CREATION_SOURCE_CONNECTOR_LIST_GRANTS_PRINCIPAL_JIT\x10\x02\"\x8e\x02\n" +
	"\x06Status\x12H\n" +
	...
	"r\b \x01(\x80\b\xd0\x01\x01R\adetails\"\x90\x01\n" +
	"\x0eResourceStatus\x12&\n" +
	"\"RESOURCE_STATUS_STATUS_UNSPECIFIED\x10\x00\x12\x1b\n" +
