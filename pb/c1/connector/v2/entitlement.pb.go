...
type EntitlementsServiceListEntitlementsRequestStream struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Resource      *Resource              `protobuf:"bytes,1,opt,name=resource,proto3" json:"resource,omitempty"`
	PageSize      uint32                 `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	PageToken     string                 `protobuf:"bytes,3,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
...
func (x *EntitlementsServiceListEntitlementsRequestStream) Reset() {
	*x = EntitlementsServiceListEntitlementsRequestStream{}
	mi := &file_c1_connector_v2_entitlement_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EntitlementsServiceListEntitlementsRequestStream) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EntitlementsServiceListEntitlementsRequestStream) ProtoMessage() {}

func (x *EntitlementsServiceListEntitlementsRequestStream) ProtoReflect() protoreflect.Message {
	mi := &file_c1_connector_v2_entitlement_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EntitlementsServiceListEntitlementsRequestStream.ProtoReflect.Descriptor instead.
func (*EntitlementsServiceListEntitlementsRequestStream) Descriptor() ([]byte, []int) {
	return file_c1_connector_v2_entitlement_proto_rawDescGZIP(), []int{3}
}

func (x *EntitlementsServiceListEntitlementsRequestStream) GetResource() *Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *EntitlementsServiceListEntitlementsRequestStream) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *EntitlementsServiceListEntitlementsRequestStream) GetAnnotations() []*anypb.Any {
	if x != nil {
		return x.Annotations
	}
	return nil
...
type EntitlementsServiceListEntitlementsResponseStream struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	List          []*Entitlement         `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	NextPageToken string                 `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	Annotations   []*anypb.Any           `protobuf:"bytes,3,rep,name=annotations,proto3" json:"annotations,omitempty"`
...
func (x *EntitlementsServiceListEntitlementsResponseStream) Reset() {
	*x = EntitlementsServiceListEntitlementsResponseStream{}
	mi := &file_c1_connector_v2_entitlement_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EntitlementsServiceListEntitlementsResponseStream) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EntitlementsServiceListEntitlementsResponseStream) ProtoMessage() {}

func (x *EntitlementsServiceListEntitlementsResponseStream) ProtoReflect() protoreflect.Message {
	mi := &file_c1_connector_v2_entitlement_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EntitlementsServiceListEntitlementsResponseStream.ProtoReflect.Descriptor instead.
func (*EntitlementsServiceListEntitlementsResponseStream) Descriptor() ([]byte, []int) {
	return file_c1_connector_v2_entitlement_proto_rawDescGZIP(), []int{4}
}

func (x *EntitlementsServiceListEntitlementsResponseStream) GetList() []*Entitlement {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *EntitlementsServiceListEntitlementsResponseStream) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
func (x *EntitlementsServiceListEntitlementsResponseStream) GetAnnotations() []*anypb.Any {
	if x != nil {
		return x.Annotations
	}
	return nil
...
var file_c1_connector_v2_entitlement_proto_rawDesc = string([]byte{
	...
	0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xf9, 0x01, 0x0a, 0x30, 0x45, 0x6e, 0x74,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x35, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x22, 0xd5, 0x01, 0x0a, 0x31, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74,
	0x45, 0x6e, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x30, 0x0a, 0x04, 0x6c, 0x69,
	0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63, 0x31, 0x2e, 0x63, 0x6f,
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x2e, 0x45, 0x6e, 0x74, 0x69, 0x74,
	0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x0f,
	...
	0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0xcb, 0x02, 0x0a,
	0x13, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x8d, 0x01, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74,
	0x69, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x3b, 0x2e, 0x63, 0x31, 0x2e, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x2e, 0x45, 0x6e, 0x74, 0x69,
	0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4c,
	...
	,
	...
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x28, 0x01, 0x30, 0x01, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69,
...
var file_c1_connector_v2_entitlement_proto_goTypes = []any{
	...
	(*EntitlementsServiceListEntitlementsRequestStream)(nil),  // 4: c1.connector.v2.EntitlementsServiceListEntitlementsRequestStream
	(*EntitlementsServiceListEntitlementsResponseStream)(nil), // 5: c1.connector.v2.EntitlementsServiceListEntitlementsResponseStream
...
var file_c1_connector_v2_entitlement_proto_depIdxs = []int32{
	...
	6,  // 8: c1.connector.v2.EntitlementsServiceListEntitlementsRequestStream.resource:type_name -> c1.connector.v2.Resource
	8,  // 9: c1.connector.v2.EntitlementsServiceListEntitlementsRequestStream.annotations:type_name -> google.protobuf.Any
	1,  // 10: c1.connector.v2.EntitlementsServiceListEntitlementsResponseStream.list:type_name -> c1.connector.v2.Entitlement
	8,  // 11: c1.connector.v2.EntitlementsServiceListEntitlementsResponseStream.annotations:type_name -> google.protobuf.Any
	2,  // 12: c1.connector.v2.EntitlementsService.ListEntitlements:input_type -> c1.connector.v2.EntitlementsServiceListEntitlementsRequest
	4,  // 13: c1.connector.v2.EntitlementsService.ListEntitlementsStream:input_type -> c1.connector.v2.EntitlementsServiceListEntitlementsRequestStream
	3,  // 14: c1.connector.v2.EntitlementsService.ListEntitlements:output_type -> c1.connector.v2.EntitlementsServiceListEntitlementsResponse
	5,  // 15: c1.connector.v2.EntitlementsService.ListEntitlementsStream:output_type -> c1.connector.v2.EntitlementsServiceListEntitlementsResponseStream
