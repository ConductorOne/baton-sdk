...
type EventFeedMetadata struct {
	...
	Id                  string      `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	SupportedEventTypes []EventType `protobuf:"varint,2,rep,packed,name=supported_event_types,json=supportedEventTypes,proto3,enum=c1.connector.v2.EventType" json:"supported_event_types,omitempty"` // TODO timing based information? or priority? something to let c1 know the timelyness or importance of the event?
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
var file_c1_connector_v2_event_feed_proto_rawDesc = string([]byte{
	...
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22, 0x90, 0x01,
	...
	0x2a, 0x69, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a,
	...
	0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x53, 0x41, 0x47, 0x45, 0x10, 0x01, 0x12,
	0x1e, 0x0a, 0x1a, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x52, 0x45,
	0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x10, 0x04, 0x22,
	0x04, 0x08, 0x02, 0x10, 0x02, 0x22, 0x04, 0x08, 0x03, 0x10, 0x03, 0x32, 0x65, 0x0a, 0x0c, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x55, 0x0a, 0x0a, 0x4c,
	0x69, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x22, 0x2e, 0x63, 0x31, 0x2e, 0x63,
...
var file_c1_connector_v2_event_feed_proto_goTypes = []any{
	...
	(*ResourceChangeEvent)(nil),   // 7: c1.connector.v2.ResourceChangeEvent
	(*EventFeedMetadata)(nil),     // 8: c1.connector.v2.EventFeedMetadata
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	(*anypb.Any)(nil),             // 10: google.protobuf.Any
	(*Resource)(nil),              // 11: c1.connector.v2.Resource
	(*Grant)(nil),                 // 12: c1.connector.v2.Grant
	(*Entitlement)(nil),           // 13: c1.connector.v2.Entitlement
	(*ResourceId)(nil),            // 14: c1.connector.v2.ResourceId
}
var file_c1_connector_v2_event_feed_proto_depIdxs = []int32{
	9,  // 0: c1.connector.v2.ListEventsRequest.start_at:type_name -> google.protobuf.Timestamp
	10, // 1: c1.connector.v2.ListEventsRequest.annotations:type_name -> google.protobuf.Any
	3,  // 2: c1.connector.v2.ListEventsResponse.events:type_name -> c1.connector.v2.Event
	10, // 3: c1.connector.v2.ListEventsResponse.annotations:type_name -> google.protobuf.Any
	9,  // 4: c1.connector.v2.Event.occurred_at:type_name -> google.protobuf.Timestamp
	4,  // 5: c1.connector.v2.Event.usage_event:type_name -> c1.connector.v2.UsageEvent
	5,  // 6: c1.connector.v2.Event.grant_event:type_name -> c1.connector.v2.GrantEvent
	6,  // 7: c1.connector.v2.Event.revoke_event:type_name -> c1.connector.v2.RevokeEvent
	7,  // 8: c1.connector.v2.Event.resource_change_event:type_name -> c1.connector.v2.ResourceChangeEvent
	10, // 9: c1.connector.v2.Event.annotations:type_name -> google.protobuf.Any
	11, // 10: c1.connector.v2.UsageEvent.target_resource:type_name -> c1.connector.v2.Resource
	11, // 11: c1.connector.v2.UsageEvent.actor_resource:type_name -> c1.connector.v2.Resource
	12, // 12: c1.connector.v2.GrantEvent.grant:type_name -> c1.connector.v2.Grant
	13, // 13: c1.connector.v2.RevokeEvent.entitlement:type_name -> c1.connector.v2.Entitlement
	11, // 14: c1.connector.v2.RevokeEvent.principal:type_name -> c1.connector.v2.Resource
	14, // 15: c1.connector.v2.ResourceChangeEvent.resource_id:type_name -> c1.connector.v2.ResourceId
	14, // 16: c1.connector.v2.ResourceChangeEvent.parent_resource_id:type_name -> c1.connector.v2.ResourceId
	0,  // 17: c1.connector.v2.EventFeedMetadata.supported_event_types:type_name -> c1.connector.v2.EventType
	1,  // 18: c1.connector.v2.EventService.ListEvents:input_type -> c1.connector.v2.ListEventsRequest
	2,  // 19: c1.connector.v2.EventService.ListEvents:output_type -> c1.connector.v2.ListEventsResponse
