...
func (x *NoEntitlements) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NoEntitlements) ProtoMessage() {}

func (x *NoEntitlements) ProtoReflect() protoreflect.Message {
	mi := &file_c1_connector_v2_annotation_resource_tree_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NoEntitlements.ProtoReflect.Descriptor instead.
func (*NoEntitlements) Descriptor() ([]byte, []int) {
...
var file_c1_connector_v2_annotation_resource_tree_proto_rawDesc = []byte{
	...
	0x22, 0x10, 0x0a, 0x0e, 0x4e, 0x6f, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e,
...
var file_c1_connector_v2_annotation_resource_tree_proto_goTypes = []interface{}{
	...
	(*NoEntitlements)(nil),    // 1: c1.connector.v2.NoEntitlements
}
