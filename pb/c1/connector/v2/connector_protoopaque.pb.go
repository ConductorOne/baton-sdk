...
type CredentialIssueOptionDescriptor struct {
	...
	xxx_hidden_VaultInboxProfiles     []VaultInboxSuite                `protobuf:"varint,11,rep,packed,name=vault_inbox_profiles,json=vaultInboxProfiles,proto3,enum=c1.connector.v2.VaultInboxSuite"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
func (x *CredentialIssueOptionDescriptor) GetVaultInboxProfiles() []VaultInboxSuite {
	if x != nil {
		return x.xxx_hidden_VaultInboxProfiles
	}
	return nil
}
...
func (x *CredentialIssueOptionDescriptor) SetVaultInboxProfiles(v []VaultInboxSuite) {
	x.xxx_hidden_VaultInboxProfiles = v
}
...
func (b0 CredentialIssueOptionDescriptor_builder) Build() *CredentialIssueOptionDescriptor {
	...
	x.xxx_hidden_VaultInboxProfiles = b.VaultInboxProfiles
	return m0
}
