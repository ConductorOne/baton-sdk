...
// whose resource carries ONLY the resource type (empty resource id); the
// connector answers with grants for the whole type, across as many
// paginated cursors as it chooses to spawn (see SpawnCursors).
//
...
func (b0 SpawnCursors_builder) Build() *SpawnCursors {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.PageTokens = b.PageTokens
	x.EstimatedTotal = b.EstimatedTotal
	return m0
}
