...
type GrantsServiceListGrantsRequest struct {
	...
	ExpandableOnly bool `protobuf:"varint,6,opt,name=expandable_only,json=expandableOnly,proto3" json:"expandable_only,omitempty"`
	// If true, only return grants that need expansion processing.
	NeedsExpansionOnly bool `protobuf:"varint,7,opt,name=needs_expansion_only,json=needsExpansionOnly,proto3" json:"needs_expansion_only,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (b0 GrantsServiceListGrantsRequest_builder) Build() *GrantsServiceListGrantsRequest {
	...
	x.ExpandableOnly = b.ExpandableOnly
	x.NeedsExpansionOnly = b.NeedsExpansionOnly
	return m0
}
