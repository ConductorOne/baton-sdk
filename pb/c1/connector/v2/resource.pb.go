...
type ResourcesGetterServiceGetResourceRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ResourceTypeId string                 `protobuf:"bytes,1,opt,name=resource_type_id,json=resourceTypeId,proto3" json:"resource_type_id,omitempty"`
...
func (x *ResourcesGetterServiceGetResourceRequest) Reset() {
	*x = ResourcesGetterServiceGetResourceRequest{}
	mi := &file_c1_connector_v2_resource_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResourcesGetterServiceGetResourceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourcesGetterServiceGetResourceRequest) ProtoMessage() {}

func (x *ResourcesGetterServiceGetResourceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_c1_connector_v2_resource_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourcesGetterServiceGetResourceRequest.ProtoReflect.Descriptor instead.
func (*ResourcesGetterServiceGetResourceRequest) Descriptor() ([]byte, []int) {
	return file_c1_connector_v2_resource_proto_rawDescGZIP(), []int{22}
}

func (x *ResourcesGetterServiceGetResourceRequest) GetResourceTypeId() string {
	if x != nil {
		return x.ResourceTypeId
	}
	return ""
...
func (x *ResourcesGetterServiceGetResourceRequest) GetResourceId() string {
	if x != nil {
		return x.ResourceId
	}
	return ""
...
type ResourcesGetterServiceGetResourceResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	List          *Resource              `protobuf:"bytes,1,opt,name=list,proto3" json:"list,omitempty"`
	Annotations   []*anypb.Any           `protobuf:"bytes,2,rep,name=annotations,proto3" json:"annotations,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ResourcesGetterServiceGetResourceResponse) Reset() {
	*x = ResourcesGetterServiceGetResourceResponse{}
	mi := &file_c1_connector_v2_resource_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResourcesGetterServiceGetResourceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourcesGetterServiceGetResourceResponse) ProtoMessage() {}

func (x *ResourcesGetterServiceGetResourceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_c1_connector_v2_resource_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourcesGetterServiceGetResourceResponse.ProtoReflect.Descriptor instead.
func (*ResourcesGetterServiceGetResourceResponse) Descriptor() ([]byte, []int) {
	return file_c1_connector_v2_resource_proto_rawDescGZIP(), []int{23}
}

func (x *ResourcesGetterServiceGetResourceResponse) GetList() *Resource {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *ResourcesGetterServiceGetResourceResponse) GetAnnotations() []*anypb.Any {
	if x != nil {
		return x.Annotations
	}
	return nil
...
var file_c1_connector_v2_resource_proto_rawDesc = string([]byte{
	...
	0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x0b,
	0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x28,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x47, 0x65, 0x74, 0x74, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x34, 0x0a, 0x10, 0x72, 0x65, 0x73, 0x6f,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64, 0x12, 0x2b,
	...
	0x0a, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22, 0x92, 0x01, 0x0a, 0x29,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x47, 0x65, 0x74, 0x74, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x04, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x31, 0x2e, 0x63, 0x6f, 0x6e,
	0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x9f, 0x01, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x47, 0x65, 0x74, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x84, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x12, 0x39, 0x2e, 0x63, 0x31, 0x2e, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f,
	0x72, 0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x47, 0x65,
...
var file_c1_connector_v2_resource_proto_goTypes = []any{
	...
	(*ResourcesGetterServiceGetResourceRequest)(nil),      // 24: c1.connector.v2.ResourcesGetterServiceGetResourceRequest
	(*ResourcesGetterServiceGetResourceResponse)(nil),     // 25: c1.connector.v2.ResourcesGetterServiceGetResourceResponse
...
var file_c1_connector_v2_resource_proto_depIdxs = []int32{
	...
	21, // 42: c1.connector.v2.ResourcesGetterServiceGetResourceResponse.list:type_name -> c1.connector.v2.Resource
	34, // 43: c1.connector.v2.ResourcesGetterServiceGetResourceResponse.annotations:type_name -> google.protobuf.Any
	21, // 44: c1.connector.v2.CreateAccountResponse.SuccessResult.resource:type_name -> c1.connector.v2.Resource
	21, // 45: c1.connector.v2.CreateAccountResponse.ActionRequiredResult.resource:type_name -> c1.connector.v2.Resource
	3,  // 46: c1.connector.v2.ResourceTypesService.ListResourceTypes:input_type -> c1.connector.v2.ResourceTypesServiceListResourceTypesRequest
	22, // 47: c1.connector.v2.ResourcesService.ListResources:input_type -> c1.connector.v2.ResourcesServiceListResourcesRequest
	24, // 48: c1.connector.v2.ResourcesGetterService.GetResource:input_type -> c1.connector.v2.ResourcesGetterServiceGetResourceRequest
	5,  // 49: c1.connector.v2.ResourceManagerService.CreateResource:input_type -> c1.connector.v2.CreateResourceRequest
	7,  // 50: c1.connector.v2.ResourceManagerService.DeleteResource:input_type -> c1.connector.v2.DeleteResourceRequest
	9,  // 51: c1.connector.v2.ResourceDeleterService.DeleteResourceV2:input_type -> c1.connector.v2.DeleteResourceV2Request
	11, // 52: c1.connector.v2.CredentialManagerService.RotateCredential:input_type -> c1.connector.v2.RotateCredentialRequest
	15, // 53: c1.connector.v2.AccountManagerService.CreateAccount:input_type -> c1.connector.v2.CreateAccountRequest
	...
	23, // 55: c1.connector.v2.ResourcesService.ListResources:output_type -> c1.connector.v2.ResourcesServiceListResourcesResponse
	25, // 56: c1.connector.v2.ResourcesGetterService.GetResource:output_type -> c1.connector.v2.ResourcesGetterServiceGetResourceResponse
	6,  // 57: c1.connector.v2.ResourceManagerService.CreateResource:output_type -> c1.connector.v2.CreateResourceResponse
	8,  // 58: c1.connector.v2.ResourceManagerService.DeleteResource:output_type -> c1.connector.v2.DeleteResourceResponse
	10, // 59: c1.connector.v2.ResourceDeleterService.DeleteResourceV2:output_type -> c1.connector.v2.DeleteResourceV2Response
	12, // 60: c1.connector.v2.CredentialManagerService.RotateCredential:output_type -> c1.connector.v2.RotateCredentialResponse
	16, // 61: c1.connector.v2.AccountManagerService.CreateAccount:output_type -> c1.connector.v2.CreateAccountResponse
