...
type ResourceIdWithParentId struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	ResourceId       *ResourceId            `protobuf:"bytes,1,opt,name=resource_id,json=resourceId,proto3" json:"resource_id,omitempty"`
...
func (x *ResourceIdWithParentId) Reset() {
	*x = ResourceIdWithParentId{}
	mi := &file_c1_connector_v2_resource_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResourceIdWithParentId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceIdWithParentId) ProtoMessage() {}

func (x *ResourceIdWithParentId) ProtoReflect() protoreflect.Message {
	mi := &file_c1_connector_v2_resource_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceIdWithParentId.ProtoReflect.Descriptor instead.
func (*ResourceIdWithParentId) Descriptor() ([]byte, []int) {
	return file_c1_connector_v2_resource_proto_rawDescGZIP(), []int{19}
}

func (x *ResourceIdWithParentId) GetResourceId() *ResourceId {
	if x != nil {
		return x.ResourceId
	}
	return nil
...
func (x *ResourceIdWithParentId) GetParentResourceId() *ResourceId {
	if x != nil {
...
var file_c1_connector_v2_resource_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xa1, 0x01, 0x0a, 0x16,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x57, 0x69, 0x74, 0x68, 0x50, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x3c, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x63, 0x65, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x12, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x72,
	...
	0x76, 0x32, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x52, 0x10, 0x70,
	0x61, 0x72, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22,
...
var file_c1_connector_v2_resource_proto_goTypes = []any{
	...
	(*ResourceIdWithParentId)(nil),                        // 21: c1.connector.v2.ResourceIdWithParentId
...
var file_c1_connector_v2_resource_proto_depIdxs = []int32{
	...
	20, // 33: c1.connector.v2.ResourceIdWithParentId.resource_id:type_name -> c1.connector.v2.ResourceId
	20, // 34: c1.connector.v2.ResourceIdWithParentId.parent_resource_id:type_name -> c1.connector.v2.ResourceId
	20, // 35: c1.connector.v2.Resource.id:type_name -> c1.connector.v2.ResourceId
	20, // 36: c1.connector.v2.Resource.parent_resource_id:type_name -> c1.connector.v2.ResourceId
	...
	20, // 40: c1.connector.v2.ResourcesServiceListResourcesRequest.parent_resource_id:type_name -> c1.connector.v2.ResourceId
	...
	20, // 44: c1.connector.v2.ResourceGetterServiceGetResourceRequest.resource_id:type_name -> c1.connector.v2.ResourceId
	20, // 45: c1.connector.v2.ResourceGetterServiceGetResourceRequest.parent_resource_id:type_name -> c1.connector.v2.ResourceId
	...
	22, // 49: c1.connector.v2.CreateAccountResponse.SuccessResult.resource:type_name -> c1.connector.v2.Resource
	22, // 50: c1.connector.v2.CreateAccountResponse.ActionRequiredResult.resource:type_name -> c1.connector.v2.Resource
	3,  // 51: c1.connector.v2.ResourceTypesService.ListResourceTypes:input_type -> c1.connector.v2.ResourceTypesServiceListResourceTypesRequest
	23, // 52: c1.connector.v2.ResourcesService.ListResources:input_type -> c1.connector.v2.ResourcesServiceListResourcesRequest
	25, // 53: c1.connector.v2.ResourceGetterService.GetResource:input_type -> c1.connector.v2.ResourceGetterServiceGetResourceRequest
	5,  // 54: c1.connector.v2.ResourceManagerService.CreateResource:input_type -> c1.connector.v2.CreateResourceRequest
	7,  // 55: c1.connector.v2.ResourceManagerService.DeleteResource:input_type -> c1.connector.v2.DeleteResourceRequest
	9,  // 56: c1.connector.v2.ResourceDeleterService.DeleteResourceV2:input_type -> c1.connector.v2.DeleteResourceV2Request
	11, // 57: c1.connector.v2.CredentialManagerService.RotateCredential:input_type -> c1.connector.v2.RotateCredentialRequest
	15, // 58: c1.connector.v2.AccountManagerService.CreateAccount:input_type -> c1.connector.v2.CreateAccountRequest
	4,  // 59: c1.connector.v2.ResourceTypesService.ListResourceTypes:output_type -> c1.connector.v2.ResourceTypesServiceListResourceTypesResponse
	24, // 60: c1.connector.v2.ResourcesService.ListResources:output_type -> c1.connector.v2.ResourcesServiceListResourcesResponse
	26, // 61: c1.connector.v2.ResourceGetterService.GetResource:output_type -> c1.connector.v2.ResourceGetterServiceGetResourceResponse
	6,  // 62: c1.connector.v2.ResourceManagerService.CreateResource:output_type -> c1.connector.v2.CreateResourceResponse
	8,  // 63: c1.connector.v2.ResourceManagerService.DeleteResource:output_type -> c1.connector.v2.DeleteResourceResponse
	10, // 64: c1.connector.v2.ResourceDeleterService.DeleteResourceV2:output_type -> c1.connector.v2.DeleteResourceV2Response
	12, // 65: c1.connector.v2.CredentialManagerService.RotateCredential:output_type -> c1.connector.v2.RotateCredentialResponse
	16, // 66: c1.connector.v2.AccountManagerService.CreateAccount:output_type -> c1.connector.v2.CreateAccountResponse
