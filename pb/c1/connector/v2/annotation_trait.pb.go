...
type ActsOnBehalfOf struct {
	...
	//
	//	*ActsOnBehalfOf_SystemIdentity
	//	*ActsOnBehalfOf_OwnerIdentity
	OnBehalfOf    isActsOnBehalfOf_OnBehalfOf `protobuf_oneof:"on_behalf_of"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActsOnBehalfOf) GetOnBehalfOf() isActsOnBehalfOf_OnBehalfOf {
	if x != nil {
		return x.OnBehalfOf
	}
	return nil
...
func (x *ActsOnBehalfOf) GetSystemIdentity() *ResourceId {
	if x != nil {
		if x, ok := x.OnBehalfOf.(*ActsOnBehalfOf_SystemIdentity); ok {
...
func (x *ActsOnBehalfOf) GetOwnerIdentity() *ResourceId {
	if x != nil {
		if x, ok := x.OnBehalfOf.(*ActsOnBehalfOf_OwnerIdentity); ok {
...
func (x *ActsOnBehalfOf) SetSystemIdentity(v *ResourceId) {
	...
	x.OnBehalfOf = &ActsOnBehalfOf_SystemIdentity{v}
}
...
func (x *ActsOnBehalfOf) SetOwnerIdentity(v *ResourceId) {
	...
	x.OnBehalfOf = &ActsOnBehalfOf_OwnerIdentity{v}
}
...
func (x *ActsOnBehalfOf) HasSystemIdentity() bool {
	...
	_, ok := x.OnBehalfOf.(*ActsOnBehalfOf_SystemIdentity)
	return ok
}
...
func (x *ActsOnBehalfOf) HasOwnerIdentity() bool {
	...
	_, ok := x.OnBehalfOf.(*ActsOnBehalfOf_OwnerIdentity)
	return ok
}
...
func (x *ActsOnBehalfOf) ClearSystemIdentity() {
	if _, ok := x.OnBehalfOf.(*ActsOnBehalfOf_SystemIdentity); ok {
		x.OnBehalfOf = nil
	}
}

func (x *ActsOnBehalfOf) ClearOwnerIdentity() {
	if _, ok := x.OnBehalfOf.(*ActsOnBehalfOf_OwnerIdentity); ok {
		x.OnBehalfOf = nil
	}
}
...
func (b0 ActsOnBehalfOf_builder) Build() *ActsOnBehalfOf {
	...
	if b.SystemIdentity != nil {
		x.OnBehalfOf = &ActsOnBehalfOf_SystemIdentity{b.SystemIdentity}
	}
	if b.OwnerIdentity != nil {
		x.OnBehalfOf = &ActsOnBehalfOf_OwnerIdentity{b.OwnerIdentity}
	}
	return m0
}
...
type AgentTrait struct {
	...
	ActsOnBehalfOf *ActsOnBehalfOf  `protobuf:"bytes,3,opt,name=acts_on_behalf_of,json=actsOnBehalfOf,proto3" json:"acts_on_behalf_of,omitempty"`
	Profile        *structpb.Struct `protobuf:"bytes,4,opt,name=profile,proto3" json:"profile,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (b0 AgentTrait_builder) Build() *AgentTrait {
	...
	x.ActsOnBehalfOf = b.ActsOnBehalfOf
	x.Profile = b.Profile
	return m0
}
...
func (x *AgentToolTrait) GetCredentialProviderRef() *ResourceId {
	if x != nil {
		return x.CredentialProviderRef
	}
	return nil
}
...
func (x *AgentToolTrait) HasCredentialProviderRef() bool {
	...
	return x.CredentialProviderRef != nil
}
...
func (x *AgentToolTrait) HasOwningResourceRef() bool {
	...
	return x.OwningResourceRef != nil
}
...
func (x *AgentToolTrait) ClearCredentialProviderRef() {
	x.CredentialProviderRef = nil
}

func (x *AgentToolTrait) ClearOwningResourceRef() {
	x.OwningResourceRef = nil
}
