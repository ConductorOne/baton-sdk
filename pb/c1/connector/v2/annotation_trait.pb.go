...
func (b0 GroupTrait_builder) Build() *GroupTrait {
	...
	x.Icon = b.Icon
	x.Profile = b.Profile
	x.GroupSourceType = b.GroupSourceType
	x.RawGroupSourceType = b.RawGroupSourceType
	return m0
}
...
func (b0 AppTrait_builder) Build() *AppTrait {
	...
	x.Profile = b.Profile
	x.Flags = b.Flags
	x.AppSourceType = b.AppSourceType
	x.RawAppSourceType = b.RawAppSourceType
	return m0
}
...
type LicenseProfileTrait struct {
	...
	PurchasedSeats int64 `protobuf:"varint,2,opt,name=purchased_seats,json=purchasedSeats,proto3" json:"purchased_seats,omitempty"`
	...
	EntitlementIds []string `protobuf:"bytes,6,rep,name=entitlement_ids,json=entitlementIds,proto3" json:"entitlement_ids,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ManagedDeviceTrait struct {
	...
	Udid            string                             `protobuf:"bytes,2,opt,name=udid,proto3" json:"udid,omitempty"`                                                                                   // Apple UDID
	HardwareHash    string                             `protobuf:"bytes,3,opt,name=hardware_hash,json=hardwareHash,proto3" json:"hardware_hash,omitempty"`                                               // Windows Autopilot hardware hash
	DeviceType      ManagedDeviceTrait_DeviceType      `protobuf:"varint,4,opt,name=device_type,json=deviceType,proto3,enum=c1.connector.v2.ManagedDeviceTrait_DeviceType" json:"device_type,omitempty"` // form factor (OCSF device.type_id taxonomy)
	...
	AssignedUser    *ResourceId                        `protobuf:"bytes,8,opt,name=assigned_user,json=assignedUser,proto3" json:"assigned_user,omitempty"`                                               // cross-link to the synced user
...
func (b0 ManagedDeviceTrait_builder) Build() *ManagedDeviceTrait {
	...
	x.Serial = b.Serial
	x.Udid = b.Udid
	x.HardwareHash = b.HardwareHash
	x.DeviceType = b.DeviceType
	x.Model = b.Model
	x.Vendor = b.Vendor
	x.Os = b.Os
	x.AssignedUser = b.AssignedUser
	x.Compliance = b.Compliance
	x.IsEncrypted = b.IsEncrypted
	x.IsSupervised = b.IsSupervised
...
type DeviceOS struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Type          DeviceOS_OsType        `protobuf:"varint,1,opt,name=type,proto3,enum=c1.connector.v2.DeviceOS_OsType" json:"type,omitempty"`
...
func (x *DeviceOS) GetBuild() string {
	return x.GetBuild_()
}
