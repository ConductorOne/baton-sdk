...
type RiskFactor struct {
	...
	xxx_hidden_Severity    RiskFactor_Severity    `protobuf:"varint,2,opt,name=severity,proto3,enum=c1.connector.v2.RiskFactor_Severity"`
...
func (x *RiskScore) GetSourceScore() string {
	if x != nil {
		return x.xxx_hidden_SourceScore
	}
	return ""
}
...
func (x *RiskScore) GetRiskFactors() []*RiskFactor {
	if x != nil {
		if x.xxx_hidden_RiskFactors != nil {
			return *x.xxx_hidden_RiskFactors
		}
	}
	return nil
}
...
func (x *RiskScore) SetSourceScore(v string) {
	x.xxx_hidden_SourceScore = v
}

func (x *RiskScore) SetRiskFactors(v []*RiskFactor) {
	x.xxx_hidden_RiskFactors = &v
}
...
func (b0 RiskScore_builder) Build() *RiskScore {
	...
	x.xxx_hidden_NormalizedScore = b.NormalizedScore
	x.xxx_hidden_SourceScore = b.SourceScore
	x.xxx_hidden_RiskFactors = &b.RiskFactors
	return m0
}
