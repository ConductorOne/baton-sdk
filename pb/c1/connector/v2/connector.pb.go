...
type CredentialIssueOptionDescriptor struct {
	...
	FullKnowledgeVaultProfiles []FullKnowledgeVaultConfig_ProtocolVersion `protobuf:"varint,11,rep,packed,name=full_knowledge_vault_profiles,json=fullKnowledgeVaultProfiles,proto3,enum=c1.connector.v2.FullKnowledgeVaultConfig_ProtocolVersion" json:"full_knowledge_vault_profiles,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *CredentialIssueOptionDescriptor) GetFullKnowledgeVaultProfiles() []FullKnowledgeVaultConfig_ProtocolVersion {
	if x != nil {
		return x.FullKnowledgeVaultProfiles
	}
	return nil
}
...
func (x *CredentialIssueOptionDescriptor) SetFullKnowledgeVaultProfiles(v []FullKnowledgeVaultConfig_ProtocolVersion) {
	x.FullKnowledgeVaultProfiles = v
}
...
func (b0 CredentialIssueOptionDescriptor_builder) Build() *CredentialIssueOptionDescriptor {
	...
	x.FullKnowledgeVaultProfiles = b.FullKnowledgeVaultProfiles
	return m0
}
