...
type ResourceTypeCapability struct {
	...
	ResourceActions []*ResourceActionSchema `protobuf:"bytes,4,rep,name=resource_actions,json=resourceActions,proto3" json:"resource_actions,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (b0 ResourceTypeCapability_builder) Build() *ResourceTypeCapability {
	...
	x.Capabilities = b.Capabilities
	x.Permissions = b.Permissions
	x.ResourceActions = b.ResourceActions
	return m0
}
