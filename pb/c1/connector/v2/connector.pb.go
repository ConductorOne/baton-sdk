...
func (b0 CredentialDetailsCredentialIssue_builder) Build() *CredentialDetailsCredentialIssue {
	...
	_, _ = b, x
	x.Options = b.Options
	x.PreferredOption = b.PreferredOption
	return m0
}
...
type CredentialIssueOptionDescriptor struct {
	...
	RequestSchema *CredentialIssueRequestSchema `protobuf:"bytes,11,opt,name=request_schema,json=requestSchema,proto3" json:"request_schema,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 CredentialIssueOptionDescriptor_builder) Build() *CredentialIssueOptionDescriptor {
	...
	x.RequestSchema = b.RequestSchema
	return m0
}
...
func (x *ResourceTypeCapability) GetSkipSyncAnomalyDetection() bool {
	if x != nil {
		return x.SkipSyncAnomalyDetection
	}
	return false
}
