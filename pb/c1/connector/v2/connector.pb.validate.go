...
// Validate checks the field values on ListEventsCapabilities with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListEventsCapabilities) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListEventsCapabilities with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListEventsCapabilitiesMultiError, or nil if none found.
func (m *ListEventsCapabilities) ValidateAll() error {
	return m.validate(true)
}

func (m *ListEventsCapabilities) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ListEventsCapabilitiesMultiError(errors)
	}

	return nil
}

// ListEventsCapabilitiesMultiError is an error wrapping multiple validation
// errors returned by ListEventsCapabilities.ValidateAll() if the designated
// constraints aren't met.
type ListEventsCapabilitiesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListEventsCapabilitiesMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListEventsCapabilitiesMultiError) AllErrors() []error { return m }

// ListEventsCapabilitiesValidationError is the validation error returned by
// ListEventsCapabilities.Validate if the designated constraints aren't met.
type ListEventsCapabilitiesValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListEventsCapabilitiesValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListEventsCapabilitiesValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListEventsCapabilitiesValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListEventsCapabilitiesValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListEventsCapabilitiesValidationError) ErrorName() string {
	return "ListEventsCapabilitiesValidationError"
}

// Error satisfies the builtin error interface
func (e ListEventsCapabilitiesValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListEventsCapabilities.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListEventsCapabilitiesValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListEventsCapabilitiesValidationError{}
...
func (m *ConnectorCapabilities) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetListEventsCapabilities()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ConnectorCapabilitiesValidationError{
					field:  "ListEventsCapabilities",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetListEventsCapabilities()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ConnectorCapabilitiesValidationError{
				field:  "ListEventsCapabilities",
				reason: "embedded message failed validation",
