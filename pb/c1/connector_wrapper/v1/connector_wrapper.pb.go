...
var file_c1_connector_wrapper_v1_connector_wrapper_proto_rawDesc = string([]byte{
	...
	0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x3e, 0x5a, 0x3c,
	...
	0x72, 0x5f, 0x77, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})
...
var file_c1_connector_wrapper_v1_connector_wrapper_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_c1_connector_wrapper_v1_connector_wrapper_proto_goTypes = []any{
	...
	(*v1.Credential)(nil),         // 2: c1.utls.v1.Credential
	(*v11.RateLimiterConfig)(nil), // 3: c1.ratelimit.v1.RateLimiterConfig
}
var file_c1_connector_wrapper_v1_connector_wrapper_proto_depIdxs = []int32{
	2, // 0: c1.connector_wrapper.v1.ServerConfig.credential:type_name -> c1.utls.v1.Credential
	3, // 1: c1.connector_wrapper.v1.ServerConfig.rate_limiter_config:type_name -> c1.ratelimit.v1.RateLimiterConfig
