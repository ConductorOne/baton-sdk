...
const file_c1_connectorapi_baton_v1_session_proto_rawDesc = "" +
	...
	"\xfaB\ar\x05\x10\x01\x18\x80\x04R\x03key\x12 \n" +
	"\x06prefix\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"9\n" +
	...
	"\x04keys\x18\x02 \x03(\tB\x15\xfaB\x12\x92\x01\x0f\b\x01\x10d\x18\x01\"\ar\x05\x10\x01\x18\x80\x04R\x04keys\x12 \n" +
	"\x06prefix\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"y\n" +
	...
	"\x06prefix\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"k\n" +
	...
	"\x03key\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\x80\x04R\x03key\x12\"\n" +
	"\x05value\x18\x03 \x01(\fB\f\xfaB\tz\a\x10\x00\x18\x80\xa0\xfc\x01R\x05value\x12 \n" +
	"\x06prefix\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"\r\n" +
	"\vSetResponse\"\x8e\x02\n" +
	"\x0eSetManyRequest\x121\n" +
	"\async_id\x18\x01 \x01(\tB\x18\xfaB\x15r\x132\x11^[a-zA-Z0-9]{27}$R\x06syncId\x12l\n" +
	"\x06values\x18\x02 \x03(\v24.c1.connectorapi.baton.v1.SetManyRequest.ValuesEntryB\x1e\xfaB\x1b\x9a\x01\x18\b\x01\x10d\"\ar\x05\x10\x01\x18\x80\x04*\tz\a\x10\x00\x18\x80\xa0\xfc\x01R\x06values\x12 \n" +
	"\x06prefix\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\x1a9\n" +
	...
	"\x03key\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\x80\x04R\x03key\x12 \n" +
	"\x06prefix\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"\x10\n" +
	"\x0eDeleteResponse\"\x92\x01\n" +
	"\x11DeleteManyRequest\x121\n" +
	"\async_id\x18\x01 \x01(\tB\x18\xfaB\x15r\x132\x11^[a-zA-Z0-9]{27}$R\x06syncId\x12(\n" +
	"\x04keys\x18\x02 \x03(\tB\x14\xfaB\x11\x92\x01\x0e\b\x01\x10\xc8\x01\"\ar\x05\x10\x01\x18\x80\x04R\x04keys\x12 \n" +
	"\x06prefix\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"\x14\n" +
	"\x12DeleteManyResponse\"c\n" +
	"\fClearRequest\x121\n" +
	"\async_id\x18\x01 \x01(\tB\x18\xfaB\x15r\x132\x11^[a-zA-Z0-9]{27}$R\x06syncId\x12 \n" +
	"\x06prefix\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x04R\x06prefix\"\x0f\n" +
