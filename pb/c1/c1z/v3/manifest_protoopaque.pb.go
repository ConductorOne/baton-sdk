...
func (x *C1ZManifestV3) GetGrantDigestRoot() *GrantDigestRoot {
	if x != nil {
		return x.xxx_hidden_GrantDigestRoot
	}
	return nil
}
...
func (x *C1ZManifestV3) HasGrantDigestRoot() bool {
	...
	return x.xxx_hidden_GrantDigestRoot != nil
}
...
func (x *C1ZManifestV3) ClearGrantDigestRoot() {
	x.xxx_hidden_GrantDigestRoot = nil
}
...
type GrantDigestRoot struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_XorDigest  []byte                 `protobuf:"bytes,1,opt,name=xor_digest,json=xorDigest,proto3"`
	xxx_hidden_Count      int64                  `protobuf:"varint,2,opt,name=count,proto3"`
	xxx_hidden_AbiVersion uint32                 `protobuf:"varint,3,opt,name=abi_version,json=abiVersion,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *GrantDigestRoot) GetAbiVersion() uint32 {
	if x != nil {
		return x.xxx_hidden_AbiVersion
	}
	return 0
}
...
func (b0 GrantDigestRoot_builder) Build() *GrantDigestRoot {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_XorDigest = b.XorDigest
	x.xxx_hidden_Count = b.Count
	x.xxx_hidden_AbiVersion = b.AbiVersion
	return m0
}
