...
type Field struct {
	...
	xxx_hidden_IsSelfHosted bool                   `protobuf:"varint,8,opt,name=is_self_hosted,json=isSelfHosted,proto3"`
...
func (x *Field) GetIsSelfHosted() bool {
	if x != nil {
		return x.xxx_hidden_IsSelfHosted
	}
	return false
}
...
func (b0 Field_builder) Build() *Field {
	...
	x.xxx_hidden_IsSelfHosted = b.IsSelfHosted
