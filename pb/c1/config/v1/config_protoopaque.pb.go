...
type Constraint struct {
	...
	xxx_hidden_AllowedOptionValues []string               `protobuf:"bytes,7,rep,name=allowed_option_values,json=allowedOptionValues,proto3"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *Constraint) GetAllowedOptionValues() []string {
	if x != nil {
		return x.xxx_hidden_AllowedOptionValues
	}
	return nil
}
...
func (x *Constraint) SetAllowedOptionValues(v []string) {
	x.xxx_hidden_AllowedOptionValues = v
}
...
func (b0 Constraint_builder) Build() *Constraint {
	...
	x.xxx_hidden_AllowedOptionValues = b.AllowedOptionValues
	return m0
}
