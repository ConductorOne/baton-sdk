...
func (x case_Field_Field) String() string {
	md := file_c1_config_v1_config_proto_msgTypes[2].Descriptor()
	if x == 0 {
		return "not set"
	}
...
const file_c1_config_v1_config_proto_rawDesc = "" +
	"\n" +
	"\x19c1/config/v1/config.proto\x12\fc1.config.v1\x1a\x18c1/config/v1/rules.proto\x1a\x19google/protobuf/any.proto\"\x93\x03\n" +
	"\rConfiguration\x12+\n" +
	...
	" \x01(\bR\x19requiresExternalConnector\"\xea\x01\n" +
	"\n" +
	"Constraint\x120\n" +
	...
	"\x0eis_field_group\x18\x06 \x01(\bR\fisFieldGroup\"\xab\x04\n" +
	"\x05Field\x12\x12\n" +
