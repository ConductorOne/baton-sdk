...
require (
	...
	github.com/cockroachdb/datadriven v1.0.3-0.20251123150250-ddff6747b112 // indirect
...
replace modernc.org/sqlite => github.com/ductone/cznic-sqlite v1.50.0-bind-perf
