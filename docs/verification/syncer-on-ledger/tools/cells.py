#!/usr/bin/env python3
"""Emit the frozen plan's finite coverage products as JSON lines."""
...
ACTIONS = (
    ...
    "entitlements", "grants", "external-resources", "assets", "expansion",
...
EXPECTED = {"P1": 5940, "P2": 363, "P3": 16, "P4": 108, "P5": 288, "P6-put": 180,
