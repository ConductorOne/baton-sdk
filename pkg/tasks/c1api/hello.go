...
func (c *helloTaskHandler) osInfo(ctx context.Context) (*v1.BatonServiceHelloRequest_OSInfo, error) {
	...
	osInfoBuilder := &v1.BatonServiceHelloRequest_OSInfo_builder{
	...
	return osInfoBuilder.Build(), nil
}

func (c *helloTaskHandler) buildInfo(ctx context.Context) *v1.BatonServiceHelloRequest_BuildInfo {
	l := ctxzap.Extract(ctx)
	buildInfoBuilder := &v1.BatonServiceHelloRequest_BuildInfo_builder{
		LangVersion:    "0.0.0",
		Package:        "/dummy/path",
...
func (c *helloTaskHandler) HandleTask(ctx context.Context) error {
	...
	requestBuilder := &v1.BatonServiceHelloRequest_builder{
		TaskId:            taskID,
		BuildInfo:         c.buildInfo(ctx),
		OsInfo:            osInfo,
		ConnectorMetadata: mdResp.GetMetadata(),
	}
	_, err = c.helpers.HelloClient().Hello(ctx, requestBuilder.Build())
	if err != nil {
