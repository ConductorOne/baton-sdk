...
func (c *actionListSchemasTaskHandler) HandleTask(ctx context.Context) error {
	...
	requestBuilder := &v2.ListActionSchemasRequest_builder{
		Annotations: t.GetAnnotations(),
	}
	resp, err := cc.ListActionSchemas(ctx, requestBuilder.Build())
	if err != nil {
...
func (c *actionGetSchemaTaskHandler) HandleTask(ctx context.Context) error {
	...
	requestBuilder := &v2.GetActionSchemaRequest_builder{
		Name:        t.GetName(),
		Annotations: t.GetAnnotations(),
	}
	resp, err := cc.GetActionSchema(ctx, requestBuilder.Build())
	if err != nil {
		return c.helpers.FinishTask(ctx, nil, nil, err)
	}
...
func (c *actionInvokeTaskHandler) HandleTask(ctx context.Context) error {
	...
	requestBuilder := &v2.InvokeActionRequest_builder{
		Name:        t.GetName(),
		Args:        t.GetArgs(),
		Annotations: t.GetAnnotations(),
	}
	resp, err := cc.InvokeAction(ctx, requestBuilder.Build())
	if err != nil {
		return c.helpers.FinishTask(ctx, nil, nil, err)
	}
...
func (c *actionStatusTaskHandler) HandleTask(ctx context.Context) error {
	...
	requestBuilder := &v2.GetActionStatusRequest_builder{
		Name:        t.GetName(),
		Id:          t.GetId(),
		Annotations: t.GetAnnotations(),
	}
	resp, err := cc.GetActionStatus(ctx, requestBuilder.Build())
	if err != nil {
		return c.helpers.FinishTask(ctx, nil, nil, err)
	}
