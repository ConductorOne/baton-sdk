...
func (c *SQLite) ListResources(ctx context.Context, request *v2.ResourcesServiceListResourcesRequest) (*v2.ResourcesServiceListResourcesResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.ListResources")
	defer span.End()
...
func (c *SQLite) GetResource(ctx context.Context, request *reader_v2.ResourcesReaderServiceGetResourceRequest) (*reader_v2.ResourcesReaderServiceGetResourceResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.GetResource")
	defer span.End()
...
func (c *SQLite) PutResources(ctx context.Context, resourceObjs ...*v2.Resource) error {
	ctx, span := tracer.Start(ctx, "SQLite.PutResources")
	defer span.End()

	return c.putResourcesInternal(ctx, bulkPutConnectorObject, resourceObjs...)
}

func (c *SQLite) PutResourcesIfNewer(ctx context.Context, resourceObjs ...*v2.Resource) error {
	ctx, span := tracer.Start(ctx, "SQLite.PutResourcesIfNewer")
	defer span.End()

	return c.putResourcesInternal(ctx, bulkPutConnectorObjectIfNewer, resourceObjs...)
}

type resourcePutFunc func(context.Context, *SQLite, string, func(m *v2.Resource) (goqu.Record, error), ...*v2.Resource) error

func (c *SQLite) putResourcesInternal(ctx context.Context, f resourcePutFunc, resourceObjs ...*v2.Resource) error {
