...
func (c *SQLite) ListGrants(ctx context.Context, request *v2.GrantsServiceListGrantsRequest) (*v2.GrantsServiceListGrantsResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.ListGrants")
	defer span.End()
...
func (c *SQLite) GetGrant(ctx context.Context, request *reader_v2.GrantsReaderServiceGetGrantRequest) (*reader_v2.GrantsReaderServiceGetGrantResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.GetGrant")
	defer span.End()
...
func (c *SQLite) ListGrantsForEntitlement(
	ctx context.Context,
	request *reader_v2.GrantsReaderServiceListGrantsForEntitlementRequest,
) (*reader_v2.GrantsReaderServiceListGrantsForEntitlementResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.ListGrantsForEntitlement")
	defer span.End()
...
func (c *SQLite) ListGrantsForPrincipal(
	ctx context.Context,
	request *reader_v2.GrantsReaderServiceListGrantsForEntitlementRequest,
) (*reader_v2.GrantsReaderServiceListGrantsForEntitlementResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.ListGrantsForPrincipal")
	defer span.End()
...
func (c *SQLite) ListGrantsForResourceType(
	ctx context.Context,
	...
	ctx, span := tracer.Start(ctx, "SQLite.ListGrantsForResourceType")
	defer span.End()
...
func (c *SQLite) PutGrants(ctx context.Context, bulkGrants ...*v2.Grant) error {
	ctx, span := tracer.Start(ctx, "SQLite.PutGrants")
	defer span.End()

	return c.putGrantsInternal(ctx, bulkPutConnectorObject, bulkGrants...)
}

func (c *SQLite) PutGrantsIfNewer(ctx context.Context, bulkGrants ...*v2.Grant) error {
	ctx, span := tracer.Start(ctx, "SQLite.PutGrantsIfNewer")
	defer span.End()

	return c.putGrantsInternal(ctx, bulkPutConnectorObjectIfNewer, bulkGrants...)
}

type grantPutFunc func(context.Context, *SQLite, string, func(m *v2.Grant) (goqu.Record, error), ...*v2.Grant) error

func (c *SQLite) putGrantsInternal(ctx context.Context, f grantPutFunc, bulkGrants ...*v2.Grant) error {
...
func (c *SQLite) DeleteGrant(ctx context.Context, grantId string) error {
	ctx, span := tracer.Start(ctx, "SQLite.DeleteGrant")
	defer span.End()
