...
func (c *SQLite) ListEntitlements(ctx context.Context, request *v2.EntitlementsServiceListEntitlementsRequest) (*v2.EntitlementsServiceListEntitlementsResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.ListEntitlements")
	defer span.End()
...
func (c *SQLite) GetEntitlement(ctx context.Context, request *reader_v2.EntitlementsReaderServiceGetEntitlementRequest) (*reader_v2.EntitlementsReaderServiceGetEntitlementResponse, error) {
	ctx, span := tracer.Start(ctx, "SQLite.GetEntitlement")
	defer span.End()
...
func (c *SQLite) PutEntitlements(ctx context.Context, entitlementObjs ...*v2.Entitlement) error {
	ctx, span := tracer.Start(ctx, "SQLite.PutEntitlements")
	defer span.End()

	return c.putEntitlementsInternal(ctx, bulkPutConnectorObject, entitlementObjs...)
}

func (c *SQLite) PutEntitlementsIfNewer(ctx context.Context, entitlementObjs ...*v2.Entitlement) error {
	ctx, span := tracer.Start(ctx, "SQLite.PutEntitlementsIfNewer")
	defer span.End()

	return c.putEntitlementsInternal(ctx, bulkPutConnectorObjectIfNewer, entitlementObjs...)
}

type entitlementPutFunc func(context.Context, *SQLite, string, func(m *v2.Entitlement) (goqu.Record, error), ...*v2.Entitlement) error

func (c *SQLite) putEntitlementsInternal(ctx context.Context, f entitlementPutFunc, entitlementObjs ...*v2.Entitlement) error {
