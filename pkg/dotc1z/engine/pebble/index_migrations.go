...
// primaries at every seal (SealGrantHashIndexAndDigests), so a file
// that predates them simply has no digests — readers see "missing,
// recalculate" (never a wrong answer) and the file's next sync seals
// them in. Open-time grant backfills have historically been incident
