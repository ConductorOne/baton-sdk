...
// existing. Treats nil incoming as "always write" (caller asserts);
// nil existing means "no prior, write unconditionally". Matches the
// SQLite EXCLUDED.discovered_at > X.discovered_at semantics.
