...
func (c *C1File) GetGrant(ctx context.Context, request *reader_v2.GrantsReaderServiceGetGrantRequest) (*reader_v2.GrantsReaderServiceGetGrantResponse, error) {
	...
	responseBuilder := &reader_v2.GrantsReaderServiceGetGrantResponse_builder{
		Grant: ret,
	}
	return responseBuilder.Build(), nil
}
...
func (c *C1File) ListGrantsForEntitlement(
	...
	responseBuilder := &reader_v2.GrantsReaderServiceListGrantsForEntitlementResponse_builder{
		List:          ret,
		NextPageToken: nextPageToken,
	}
	return responseBuilder.Build(), nil
...
func (c *C1File) ListGrantsForResourceType(
	...
	responseBuilder := &reader_v2.GrantsReaderServiceListGrantsForResourceTypeResponse_builder{
		List:          ret,
		NextPageToken: nextPageToken,
	}
	return responseBuilder.Build(), nil
