...
const (
	...
	// WithEngine; the default engine is EnginePebble.
	EngineSQLite Engine = "sqlite"

	// EnginePebble is the v3 engine and the default when callers do not
	// specify one: a Pebble LSM wrapped in the v3
