...
var (
	...
	eventFeedEventTypesField = StringSliceField("event-types", WithHidden(true), WithDescription("The event types to read from the feed"), WithPersistent(true), WithExportTarget(ExportTargetNone))
