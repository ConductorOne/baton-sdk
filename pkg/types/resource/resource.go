...
func WithCredentialTrait(opts ...CredentialTraitOption) ResourceOption {
	return func(r *v2.Resource) error {
		rt := &v2.CredentialTrait{}
...
func NewCredentialResource(
	...
	resourceType *v2.ResourceType,
	objectID interface{},
	traitOpts []CredentialTraitOption,
	opts ...ResourceOption,
) (*v2.Resource, error) {
	opts = append(opts, WithCredentialTrait(traitOpts...))
