...
// DPoPProofer is responsible for creating DPoP proof tokens
...
// NewDPoPProofer creates a new DPoP signer with the given private key
func NewDPoPProofer(key crypto.PrivateKey) (*DPoPProofer, error) {
...
func (s *DPoPProofer) Proof(method string, url string, accessToken string, nonce string) (string, error) {
