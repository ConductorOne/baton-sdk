...
# Walker (62 cells) and graph (66 cells) each take on the order of half
...
formal-walker-sweep: p-checker-guard ## Compile and sweep the walker model (62 cells; needs P).
