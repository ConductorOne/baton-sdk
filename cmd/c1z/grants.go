...
func listGrantsForEntitlement(ctx context.Context, cmd *cobra.Command, store *dotc1z.C1File, pageToken string) ([]*v2.Grant, string, error) {
...
func listGrantsForResource(ctx context.Context, cmd *cobra.Command, store *dotc1z.C1File, pageToken string) ([]*v2.Grant, string, error) {
...
func listAllGrants(ctx context.Context, store *dotc1z.C1File, pageToken string) ([]*v2.Grant, string, error) {
	req := &v2.GrantsServiceListGrantsRequest{
		PageToken: pageToken,
	}
	resp, err := store.ListGrants(ctx, req)
